...
public class LavaCandleThreeTieredCakeBlock extends BaseThreeTieredCandleCakeBlock {

    public LavaCandleThreeTieredCakeBlock(BaseCakeBlock originalCake, Block candle, Properties properties) {
