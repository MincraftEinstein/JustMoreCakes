...
public class SculkTwoTieredCakeBlock extends BaseTwoTieredCakeBlock {

    public static final EnumProperty<SculkSensorPhase> PHASE = BlockStateProperties.SCULK_SENSOR_PHASE;

    public SculkTwoTieredCakeBlock(CakeVariant builder) {
        super(builder);
    ...
    public BlockState eatActions(Player player, BlockPos pos, BlockState state) {
        ...
        return SculkCakeBlock.activate(player, player.level(), pos, state, true);
    }
