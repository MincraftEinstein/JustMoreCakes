...
public class ModItems {
    ...
    public static final Supplier<Item> CUPCAKE = Services.REGISTRY.registerItem("cupcake", () -> new ItemNameBlockItem(ModBlocks.CUPCAKE_VARIANT.getCake().get(), new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.3F).build())));
