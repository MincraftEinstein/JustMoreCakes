...
public class ModBlocks {
    ...
    public static final DefaultCakeFamily SLIME_CAKE_FAMILY = CakeFamily.create("slime")
            .modifyBaseBuilder(builder -> builder.setCakeProperties(cakeProperties().sound(SoundType.SLIME_BLOCK))
            ...
            .modifyTwoTieredBuilder(builder -> builder.setCakeProperties(cakeProperties().sound(SoundType.SLIME_BLOCK))
                    .setCandleCakeProperties(candleCakeProperties().sound(SoundType.SLIME_BLOCK))
                    .setBothClasses(SlimeTwoTieredCakeBlock::new, SlimeCandleTwoTieredCakeBlock::new))
            .modifyThreeTieredBuilder(builder -> builder.setCakeProperties(cakeProperties().sound(SoundType.SLIME_BLOCK))
                    .setCandleCakeProperties(candleCakeProperties().sound(SoundType.SLIME_BLOCK))
                    .setBothClasses(SlimeThreeTieredCakeBlock::new, SlimeCandleThreeTieredCakeBlock::new))
            .build();
