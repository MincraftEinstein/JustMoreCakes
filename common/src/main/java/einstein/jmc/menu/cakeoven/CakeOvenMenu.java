    ...
    public ItemStack quickMoveStack(Player player, int slotIndex) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (slotIndex == RESULT_SLOT) {    // For the result slot
                ...
                // For the ingredient slots
                else if (!moveItemStackTo(stack1, 0, FUEL_SLOT, false)) { // All slots from 0 to fuel (fuel slot is excluded)
                    return ItemStack.EMPTY;
                }
                ...
                else if (slotIndex < hotbarEnd && !moveItemStackTo(stack1, containerSize, inventoryEnd, false)) {
                    return ItemStack.EMPTY;
                }
            }
