...
public class ModConfigs {
	...
	public static final ForgeConfigSpec.Builder BUILDER = new ForgeConfigSpec.Builder().comment("Server configuration settings").push("server");
	...
	private static final ForgeConfigSpec SERVERSPEC = BUILDER.build();
	...
	public static IntValue registerIntValues(final String comment, final String field, final int defaultInt, final int minInt, final int maxInt) {
		return BUILDER.comment(comment).defineInRange(field, defaultInt, minInt, maxInt);
	}
