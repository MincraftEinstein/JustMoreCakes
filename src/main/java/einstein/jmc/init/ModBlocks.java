...
public class ModBlocks
{
    ...
    public static final Block RED_MUSHROOM_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "red_mushroom_cake", new CakeBlock(BlockBehaviour.Properties.copy(Blocks.CAKE)), JustMoreCakes.JMC_TAB);
    ...
    public static final Block BROWN_MUSHROOM_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "brown_mushroom_cake", new CakeBlock(BlockBehaviour.Properties.copy(Blocks.CAKE)), JustMoreCakes.JMC_TAB);
    ...
    public static final Block CRIMSON_FUNGUS_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "crimson_fungus_cake", new CakeBlock(BlockBehaviour.Properties.copy(Blocks.CAKE)), JustMoreCakes.JMC_TAB);
    public static final Block WARPED_FUNGUS_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "warped_fungus_cake", new CakeBlock(BlockBehaviour.Properties.copy(Blocks.CAKE)), JustMoreCakes.JMC_TAB);
