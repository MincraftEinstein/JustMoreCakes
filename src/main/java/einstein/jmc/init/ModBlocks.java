...
import einstein.jmc.blocks.IceCakeBlock;
...
public class ModBlocks
{
    ...
    public static final Block MELON_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "melon_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block APPLE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "apple_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block POISON_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "poison_cake", new PoisonCakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block COOKIE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "cookie_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block TNT_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "tnt_cake", new TNTCakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block GOLDEN_APPLE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "golden_apple_cake", new GoldenAppleCakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block RED_MUSHROOM_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "red_mushroom_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block FIREY_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "firey_cake", new FireyCakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    ...
    public static final Block BEETROOT_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "beetroot_cake", new BeetrootCakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block LAVA_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "lava_cake", new LavaCakeBlock(Block.Properties.from(Blocks.CAKE).setLightLevel((state) -> {
        return 9;
    })), JustMoreCakes.JMC_GROUP);
    ...
    public static final Block CHRISTMAS_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "christmas_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block SPRINKLE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "sprinkle_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block SWEET_BERRY_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "sweet_berry_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block HONEY_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "honey_cake", new CakeBlock(Block.Properties.from(Blocks.CAKE)), JustMoreCakes.JMC_GROUP);
    public static final Block GLOWSTONE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "glowstone_cake", new GlowstoneCakeBlock(Block.Properties.from(Blocks.CAKE).setLightLevel((state) -> {
    	return 12;
    })), JustMoreCakes.JMC_GROUP);
