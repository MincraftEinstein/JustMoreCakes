...
public class ModBlocks
{
    ...
    public static final Block REDSTONE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "redstone_cake", new CakeBlockBase(Block.Properties.create(Material.CAKE).sound(SoundType.CLOTH).hardnessAndResistance(0.5F)), JMCItemGroup.instance);
    ...
    public static final Block CHEESE_CAKE = RegistryHandler.registerBlock(JustMoreCakes.MODID, "cheese_cake", new CakeBlockBase(Block.Properties.create(Material.CAKE).sound(SoundType.CLOTH).hardnessAndResistance(0.5F)), JMCItemGroup.instance);
