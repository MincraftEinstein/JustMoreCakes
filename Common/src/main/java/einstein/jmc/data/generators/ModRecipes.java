...
public class ModRecipes {
    ...
    private static void cakeOvenRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        CakeOvenRecipeBuilder.cakeBaking(ModBlocks.CHEESECAKE.get(), 0.7F, 250, Ingredient.of(ModItemTags.CHEESE), Ingredient.of(Items.EGG), Ingredient.of(Items.SUGAR), Ingredient.of(Items.WHEAT))
        ...
        CakeOvenRecipeBuilder.cakeBaking(ModBlocks.RED_VELVET_CAKE.get(), 0.8F, 300, Ingredient.of(ModItemTags.RED_DYE), Ingredient.of(Items.COCOA_BEANS), Ingredient.of(Items.MILK_BUCKET), Ingredient.of(Items.EGG))
                .unlockedBy(has, RecipeProvider.has(Items.COCOA_BEANS))
        ...
        CakeOvenRecipeBuilder.cakeBaking(ModBlocks.SEED_CAKE.get(), 0.3F, 150, Ingredient.of(ModItemTags.SEEDS), Ingredient.of(Items.MILK_BUCKET), Ingredient.of(Items.EGG), Ingredient.of(Items.SUGAR))
                .unlockedBy(has, RecipeProvider.has(ModItemTags.SEEDS))
                .save(consumer, cakeOvenLoc(ModBlocks.SEED_CAKE));

        CakeOvenRecipeBuilder.cakeBaking(ModBlocks.SLIME_CAKE.get(), 0.8F, 300, Ingredient.of(ModItemTags.SLIME_BALLS), Ingredient.of(Items.SUGAR), Ingredient.of(Items.WHEAT), Ingredient.of(Items.EGG))
