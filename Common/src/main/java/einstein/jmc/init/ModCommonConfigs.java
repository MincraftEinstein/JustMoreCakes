...
public class ModCommonConfigs {
    ...
    public static final ForgeConfigSpec.DoubleValue CHORUS_CAKE_TELEPORT_RADIUS = BUILDER.comment("The radius in which the player will be randomly teleported")
            .defineInRange("chorusCakeTeleportRadius", 10, 0, 10000D);
    public static final ForgeConfigSpec.DoubleValue ENDER_CAKE_TELEPORT_RADIUS = BUILDER.comment("The radius in which the player will be randomly teleported")
    ...
    public static final ForgeConfigSpec.IntValue ENCASING_ICE_MELT_SPEED = BUILDER.comment("How long it takes for encasing ice to melt in ticks")
