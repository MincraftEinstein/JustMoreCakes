...
public class ModPotions {
    ...
    public static final Supplier<MobEffect> SNEAKING_EFFECT = Services.REGISTRY.registerMobEffect("sneaking", () -> new MobEffect(MobEffectCategory.BENEFICIAL, 556673));
    ...
    public static final Supplier<Potion> SNEAKING_POTION = Services.REGISTRY.registerPotion("sneaking", () -> new Potion(new MobEffectInstance(SNEAKING_EFFECT.get(), 600)));
    ...
    public static void registerPotionRecipes() {
        ...
        Services.HOOKS.registerBrewingRecipe(Potions.AWKWARD, Ingredient.of(Items.ECHO_SHARD), SNEAKING_POTION.get());
    }
